				...
				<div class="col-md-10 col-lg-8 p-b-80">
					<div class="p-r-10 p-r-0-sr991">
						<div class="m-t--65 p-b-40">
							<?php
							$extension = DB:: getInstance()->query("SELECT *,LEFT(ext_content,350)ext_content FROM extension");							
							foreach($extension->results() as $extension){?>
								<!-- Item Blog -->
								<div class="flex-col-s-c how-bor2 p-t-65 p-b-40">
									<h5 class="p-b-17 txt-center">
										<a href="extension.php?id=<?php echo $extension->id;?>" class="f1-l-1 cl2 hov-cl10 trans-03 respon2">
									...
									<a href="extension.php?id=<?php echo $extension->id;?>" class="wrap-pic-w hov1 trans-03 m-b-30">
									...
									<a href="extension.php?id=<?php echo $extension->id;?>" class="f1-s-1 cl9 hov-cl10 trans-03">
										Read More
