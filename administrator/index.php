				...
				<div class="col-md-6 col-lg-6 p-b-80">
					<div class="p-r-10 p-r-0-sr991">
						<form method="post" action="">
								...
								<?php }?>
							<label style="font-size: 20px;padding-bottom:5px;" for="permission">WELCOME IBANIAN</label>
							<select class="bo-1-rad-3 bocl13 size-a-19 f1-s-13 cl5 plh6 p-rl-18 m-b-20" class="form-control" name="permission" id="permission" required>
								<p hidden value="">WELCOME IBANIAN </p>
								<?php
									$permission = DB:: getInstance()->query("SELECT * FROM groups where ID = 1");
