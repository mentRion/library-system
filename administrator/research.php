	...
	<div class="container">
		<div class="headline bg0 flex-wr-sb-c p-rl-20 p-tb-8">
			<div class="f2-s-1 p-r-30 m-tb-6">
				...
				<a href="researchList.php" class="breadcrumb-item f1-s-3 cl9">
					Research List 
				</a>
				<?php
						...
						<div class="p-b-70">
							...
							<div class="flex-s-s p-t-12 p-b-15">
								...
								<div class="flex-wr-s-s size-w-0">
									<a href="admin/uploads/researchfiles/<?php echo $research->researchfile; ?>" target="_blank" class="dis-block f1-s-13 cl0 bg-google borad-3 p-tb-4 p-rl-18 hov-btn1 m-r-3 m-b-3 trans-03">
