    ...
    if(Token::check(Input::get('token'))) {
		$topic = new Topic();
			try {
				...
				Session::flash('Updated', 'Topic Info has been successfully updated.');
                ...
                <section class="content">
                    <div class="col-xs-12">
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                <?php 
									$topic = DB:: getInstance()->query("SELECT * FROM topics WHERE id=".$_GET['id']."");							
								...
								<form id="editUser" action="" method="post">
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4">
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="topic" name="topic" value="<?php echo $topic->topicTitle; ?>">
                                            </div>
                                        </div>
									</div>
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <button type="button" class="btn btn" onclick="window.location='admin.php?action=listTopics'">Cancel</button>
                                    </div>
                                    <br />
                                </form>         
								<?php }?>                 
