<?php
if (Input::exists()) {
		$programType = DB:: getInstance()->delete('programType', array('id','=',Input::get('id')));													
                        ...
                        <div class="col-xs-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Type of Programs</h3>    
                                ...
                                <div class="box-body table-responsive">
                                    ...
                                    <?php }?>
									<?php if(Session::exists('ProgramTypeAdded')) { ?>
                                                 <div class="alert alert-success">
                                                    <i class="glyphicon glyphicon-ok"></i> &nbsp;<?php echo Session::flash('ProgramTypeAdded'); ?>
                                                 </div>
                                        <?php }?>
														...
														<tr>
															...
															<td align="center">
																...
																<form method="POST" action="" style="display:inline">
																	<input type="hidden" name="id" value="<?php echo $programType->id;  ?>">
																...
																<form method="POST" action="admin.php?action=editProgramType&&id=<?php echo $programType->id; ?>" style="display:inline">
								...
								<div class="box-footer">
									...
									<div class="modal-dialog" role="document">
										...
										<div class="modal-header">
											...
											<h3 class="modal-title" id="exampleModalLabel">Add New Program Type</h3>
										</div>
										<div class="modal-body">
											<form method="post" action="addProgramType.php">
												<div class="form-group">
													<label for="type">Type of Program</label>
													<input type="text" class="form-control" name="type" placeholder="Enter Program Type" required>
												</div>
										</div>
