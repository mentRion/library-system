<?php
if (Input::exists()) {
		$category = DB:: getInstance()->delete('category', array('id','=',Input::get('id')));													
                        ...
                        <div class="col-xs-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Article Category List</h3>    
												...
												foreach($category->results() as $category){?>
														<tr>
															...
															<td align="center">
																...
																<form method="POST" action="admin.php?action=editCategory&&id=<?php echo $category->id; ?>" style="display:inline">
								...
								<div class="box-footer">
									...
									<div class="modal-dialog" role="document">
										...
										<div class="modal-header">
											...
											<h3 class="modal-title" id="exampleModalLabel">Add New Article Category</h3>
										</div>
