				...
				<div class="col-md-10 col-lg-8 p-b-80">
					<div class="p-r-10 p-r-0-sr991">
						<div class="m-t--65 p-b-40">
							<?php
							$article = DB:: getInstance()->query("SELECT *,LEFT(article_content,350)article_content FROM articles WHERE article_category=".$_GET['id']."");							
							foreach($article->results() as $article){?>
								<!-- Item Blog -->
								<div class="flex-col-s-c how-bor2 p-t-10 p-b-10">
									<h5 class="p-b-17 txt-center">
										<a href="viewArticle.php?id=<?php echo $article->id;?>" class="f1-l-1 cl2 hov-cl10 trans-03 respon2">
									...
									<a href="viewArticle.php?id=<?php echo $article->id;?>" class="wrap-pic-w hov1 trans-03 m-b-30">
									...
									<a href="viewArticle.php?id=<?php echo $article->id;?>" class="f1-s-1 cl9 hov-cl10 trans-03">
										Read More
