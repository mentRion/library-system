            ...
            <div class="p-5">
              ...
              <form class="user">
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user" id="lname" name="lname" placeholder="Last Name">
                  </div>
                </div>
              ...
              <hr>
              <div class="text-center">
                <a class="small" href="elearning-login.php">Already have an account? Login!</a>
              </div>
            </div>
          </div>
        </div>
